...
There are many capable model training techniques available. Often times, such as in a production environment, it may be optimal to also consider time efficiency before settling on the model of choice.